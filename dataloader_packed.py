...
if __name__ == '__main__':
    ...
    dataset = PatientDataset('/home/comp/cssniu/mllt_backup/mllt/dataset/packed_data/',flag="train")
    batch_size = 1
    ...
    # print(Counter(label_list).most_common(50))

    #### top 15 #######
    # ['428.0','38.93','401.9','427.31','584.9','250.00','414.01','272.4','518.81','599.0','530.81','96.04','39.95','585.6','285.9']
    # [('428.0', 1310), ('38.93', 1107), ('401.9', 1045), ('427.31', 870), ('584.9', 857), ('250.00', 650), 
    # ('414.01', 649), ('272.4', 611), ('518.81', 583), ('599.0', 564), ('530.81', 522), ('96.04', 510), ('39.95', 501), ('585.6', 463), ('285.9', 441)
        # print(inputs)

        # print(text[0]['input_ids'].shape)
        # pass
