                ...
                for p in range(len(text_list)):
                    ...
                    for v in range(len(p_text)):
                        ...
                        if v == 0:
                            ...
                            q_ztd = KL_loss(Ztd_logvar_priori,Ztd_mean_priori,Ztd_mean_post, Ztd_logvar_post)
